    ...
    return (
        <div>
            <div className="mt-5 flex justify-center">
                <button onClick={toggleGridLayout} className="px-4 py-2 mr-2 text-white bg-orange-600 font-semibold rounded-md shadow-md focus:outline-none">Toggle Grid Layout</button>
            </div>
