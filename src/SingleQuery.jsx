...
const SingleQuery = ({ query }) => {
    ...
    return (
        <div className=" overflow-hidden w-[350px]  mx-auto bg-white rounded-lg shadow-lg transform hover:scale-105 transition duration-300 ease-in-out hover:shadow-xl">
